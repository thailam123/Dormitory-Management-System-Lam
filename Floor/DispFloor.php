    ...
    while ($row1 = mysqli_fetch_array($query)) {
      ...
      <tr>
        ...
        <td style="width: 140px;">
          <button id="delete"><a href="Delete.php?Floor_Number=<?php echo $row1["Floor_Number"]; ?>"
              style=" text-decoration:none; " id="link1">Delete</a></button>
          <button id="update"><a href="Update.php?Floor_Number=<?php echo $row1["Floor_Number"]; ?>"
              style=" text-decoration:none; " id="link1">Update</a></button>
        </td>
      </tr>
    <?php
    }
