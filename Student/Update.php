...
<body>
  <form name="frmUser" method="post" action="">
    ...
    <section class="sec">
      ...
      <br>
      Department:<br>
      <input style="width: 50%; height:30px; " type="text" name="Department" class="txtField"
        value="<?php echo $row['Department']; ?>">
      <br>
      Session:<br>
      <input style="width: 50%; height:30px; " type="text" name="Session" class="txtField"
        value="<?php echo $row['Session']; ?>">
      <br>
      Room_Number:<br>
      <input style="width: 50%; height:30px; " type="number" name="Room_Number" class="txtField"
        value="<?php echo $row['Room_Number']; ?>">
      <br>
      Floor_Number:<br>
      <input style="width: 50%; height:30px; " type="text" name="Floor_Number" class="txtField"
        value="<?php echo $row['Floor_Number']; ?>">
      <br>
